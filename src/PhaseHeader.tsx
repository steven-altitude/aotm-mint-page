  ...
  return (
    <Grid container justifyContent="center">
      <Grid xs={12} justifyContent="center" direction="column">
        ...
        <Typography align="center" style={{whiteSpace: 'pre'}} variant="body1" color="textSecondary">
          {desc}
        </Typography>
      </Grid>
...
export const PhaseHeader = ({
  ...
  return (
    <>
      ...
      {phase === Phase.Phase4 && (
        <Header
          phaseName={candyMachinePredatesFairLaunch ? 'AotM' : 'AotM'}
          desc={"Free Mint\nRedeemed "+candyMachine?.state.itemsRedeemed.toString() + '/' +  candyMachine?.state.itemsAvailable}
          date={undefined}
        />
      )}
    </>
